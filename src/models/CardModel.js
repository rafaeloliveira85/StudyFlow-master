...
export class GoalCardModel extends CardModel{
    #percetage;
    
    constructor(title,percetage){
        super(title);

        this.setPercetange(percetage);
    }

      setPercetange(value){
        if(value <0 || value > 100){
            throw new Error('A porcentagem deve estar entre 0% a 100%');
        }
        this.#percetage = value;  
    }
        getPercentage(){
